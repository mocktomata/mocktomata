...
module.exports = {
	...
	moduleNameMapper: {
		...
		'^(\\.{1,2}/.*)\\.js$': '$1',
		chalk,
		'#ansi-styles': path.join(chalkRootDir, 'chalk/source/vendor/ansi-styles/index.js'),
		'#supports-color': path.join(chalkRootDir, 'chalk/source/vendor/supports-color/index.js')
	},
	roots: ['<rootDir>/ts'],
	transform: {
		'^.+\\.m?[t]sx?$': [
