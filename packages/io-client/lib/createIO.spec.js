...
var file_server_1 = require("@komondor-lab/file-server");
...
beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                file_server_1.context.get().repository = test_util_1.createFakeRepository();
                return [4 /*yield*/, file_server_1.start()];
            case 1:
                server = _a.sent();
                return [2 /*return*/];
        }
...
test('read not exist spec throws SpecNotFound', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, _1.createIO()];
            case 1:
                io = _a.sent();
...
test('write spec', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                repo = file_server_1.context.get().repository;
