...
var createIO_1 = require("./createIO");
var test_util_1 = require("./test-util");
beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        context_1.context.get().repository = test_util_1.createFakeRepository();
        return [2 /*return*/];
    });
}); });
...
test('write spec', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                repo = context_1.context.get().repository;
                return [4 /*yield*/, repo.readSpec('new spec')];
            case 2:
                spec = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                repo = context_1.context.get().repository;
                return [4 /*yield*/, repo.readScenario('new scenario')];
            case 2:
                scenario = _a.sent();
...
describe('loadPlugin()', function () {
    test('load npm plugin package', function () { return __awaiter(_this, void 0, void 0, function () {
        var io, actual;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    actual = _a.sent();
                    assert_1.default.strictEqual(typeof actual.activate, 'function');
                    return [2 /*return*/];
            }
        });
    }); });
    test('can load plugin using deep link', function () { return __awaiter(_this, void 0, void 0, function () {
        var io, actual;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    io = createIO_1.createIO();
                    return [4 /*yield*/, io.loadPlugin('@komondor-lab/plugin-fixture-deep-link/pluginA')];
                case 1:
                    actual = _a.sent();
                    assert_1.default.strictEqual(typeof actual.activate, 'function');
                    return [2 /*return*/];
