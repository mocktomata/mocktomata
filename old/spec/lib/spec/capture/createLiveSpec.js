...
function createLiveSpec(_a, id, subject, options) {
    var log = _a.log;
    return __awaiter(this, void 0, void 0, function () {
        var plugin, recorder, idleWarning;
        return __generator(this, function (_b) {
            plugin = plugin_1.findPlugin(subject);
            if (!plugin) {
                throw new errors_1.NotSpecable(subject);
            }
            recorder = new Recorder_1.Recorder(plugin.name);
            idleWarning = createTimeoutWarning_1.createTimeoutWarning(log, options.timeout);
            return [2 /*return*/, {
