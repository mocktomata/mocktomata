  ...
  return noReturn.doSomething(s.subject)
    .then(() => {
      return s.satisfy([
        ...
        { type: 'promise', name: 'resolve', invokeId: 1, instanceId: 1 }
      ])
    })
})
  ...
  return promise.increment(s.subject, 2)
    ...
    .catch(() => {
      return s.satisfy([
        { type: 'function', name: 'invoke', payload: ['increment', 2], invokeId: 1, instanceId: 1 },
        { type: 'function', name: 'return', payload: {}, invokeId: 1, returnType: 'promise', returnInstanceId: 1, instanceId: 1 },
        { type: 'promise', name: 'reject', payload: { message: 'fail' }, invokeId: 1, instanceId: 1 }
      ])
    })
})
  ...
  return promise.increment(s.subject, 2)
    .then(actualFn => {
      ...
      return s.satisfy([
        { type: 'function', name: 'invoke', payload: ['increment', 2], invokeId: 1, instanceId: 1 },
        { type: 'function', name: 'return', payload: {}, invokeId: 1, returnType: 'promise', returnInstanceId: 1, instanceId: 1 },
        { type: 'promise', name: 'resolve', invokeId: 1, returnType: 'function', returnInstanceId: 2, instanceId: 1 },
        {
          type: 'function',
          name: 'invoke',
          invokeId: 1,
