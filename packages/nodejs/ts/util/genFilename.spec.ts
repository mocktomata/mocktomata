...
it('trims the string when it is too long', () => {
  const actual = genFilename('baseDir', 'this is a somewhat long description of a test. which is okey up to this point, but when it gets longer than around here, it is too long to deal with')
...
const longBase230 = '12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890'
