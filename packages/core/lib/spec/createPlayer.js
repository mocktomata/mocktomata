...
var getRef_1 = require("./getRef");
function createPlayer(context, id, options) {
    var record = { refs: [], actions: [] };
    return {
        getStub: function (subject) {
...
function getStub(record, subject) {
    ...
    var stubContext = createStubContext(record, plugin, subject);
...
function createStubContext(record, plugin, subject) {
    return {
        newStubRecorder: function (stub, meta) {
            var ref = getRef_1.getRef(record, stub);
            return {
                invoke: function (args) {
                    ...
                    var stubbedArgs = args.map(function (arg) { return getStub(record, arg); });
                    return {
                        stubbedArgs: stubbedArgs,
                    };
                }
            };
        }
