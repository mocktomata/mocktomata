    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                io.addPluginModule('@komondor-lab/plugin-fixture-dummy', test_util_1.echoPluginModule);
...
test('registering plugin with the same name throws PluginAlreadyLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, assertron_1.default.throws(function () { return _1.loadPlugins({ io: io }); }, _1.DuplicatePlugin)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, assertron_1.default.throws(function () { return _1.loadPlugins({ io: io }); }, _1.NoActivate)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, assertron_1.default.throws(function () { return _1.loadPlugins({ io: io }); }, _1.PluginNotConforming)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
