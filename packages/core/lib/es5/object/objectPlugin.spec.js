...
var objectPlugin_1 = require("./objectPlugin");
...
test('support object', function () {
    expect(objectPlugin_1.objectPlugin.support({})).toBe(true);
});
//# sourceMappingURL=objectPlugin.spec.js.map