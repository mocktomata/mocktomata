...
function createIO(options) {
    var repo = options ?
        context_1.context.get().repository = io_fs_1.createFileRepository(options.cwd) :
        context_1.context.get().repository;
    return {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, repo.readSpec(id)];
                        case 1:
                            specStr = _b.sent();
                            return [2 /*return*/, JSON.parse(specStr)];
                        case 2:
                            _a = _b.sent();
        ...
        writeSpec: function (id, record) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, repo.writeSpec(id, JSON.stringify(record))];
                });
            });
        },
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, repo.readScenario(id)];
                        case 1:
                            specStr = _b.sent();
                            return [2 /*return*/, JSON.parse(specStr)];
                        case 2:
        ...
        writeScenario: function (id, record) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, repo.writeScenario(id, JSON.stringify(record))];
                });
            });
        },
        getPluginList: function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, repo.getPluginList()];
                });
            });
        },
