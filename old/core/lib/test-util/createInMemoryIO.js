...
function createInMemoryIO() {
    return {
        ...
        loadPlugin: function (name) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    throw new plugin_1.PluginNotFound(name);
                });
            });
        },
        readScenario: function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    throw new scenario_1.ScenarioNotFound(id);
                });
            });
        },
        readSpec: function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    throw new spec_1.SpecNotFound(id);
                });
            });
        },
...
exports.createInMemoryIO = createInMemoryIO;
