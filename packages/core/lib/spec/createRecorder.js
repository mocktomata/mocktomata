...
function getSpy(record, subject, source) {
    ...
    var spyContext = createSpyContext(record, plugin, subject);
...
function createSpyContext(record, plugin, subject) {
    return {
        newSpyRecorder: function (spy, meta) {
            var ref = getRef_1.getRef(record, spy);
            return {
                ...
                invoke: function (args) {
                    ...
                    var spiedArgs = args.map(function (arg, i) { return getSpy(record, arg, { ref: ref, site: [i] }); });
                    return {
                        spiedArgs: spiedArgs,
