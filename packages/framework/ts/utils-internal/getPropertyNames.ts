import { isBaseObject } from '../utils/isBaseObject.js'
...
function getInheritedPropertyNamesInternal(subjectClass: new () => any, names: string[]): string[] {
	...
	return proto.prototype === undefined
		? names
		: getInheritedPropertyNamesInternal(proto, uniq(names, Object.getOwnPropertyNames(proto.prototype)))
}
