...
import { findPlugin } from '../spec_plugin/index.js'
...
export function createSpecRecordValidator(specName: string, loaded: SpecRecord) {
	...
	return {
		...
		getNextExpectedAction(): SpecRecordLive.Action | undefined {
			return loaded.actions[actions.length]
		},
		getNextActionId() {
...
): SpecRecord.Reference | undefined {
